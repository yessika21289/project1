                            ...
                            <div class="col-md-10">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php
                                            if(!empty($member['facebook'])) echo $member['facebook'];
                                            else echo '-';
                                        ?>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <?php
                                            if(!empty($member['instagram'])) echo $member['instagram'];
                                            else echo '-';
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php
                                            if(!empty($member['twitter'])) echo $member['twitter'];
                                            else echo '-';
                                        ?>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <?php
                                            if(!empty($member['path'])) echo $member['path'];
                                            else echo '-';
                                        ?>
                                    </div>
                                </div>
