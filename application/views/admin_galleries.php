...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row" style="margin: 0 0 15px 0;">
            <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/Galleries/add" title="Add Gallery">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-primary" title="Edit"
                                               href="<?php echo base_url() ?>admin/Galleries/edit/<?php echo $album->id; ?>">
                                                <i class="icon_pencil-edit"></i></a>
                                            <?php if($album->is_active == 0): ?>
                                                <a class="btn btn-success" title="Publish"
                                                   href="<?php echo base_url() ?>admin/Galleries/add?id=<?php echo $album->id; ?>&is_active=1">
                                                    <i class="icon_cloud-upload_alt"></i></a>
                                            <?php else: ?>
                                                <a class="btn btn-warning" title="Unpublish"
                                                   href="<?php echo base_url() ?>admin/Galleries/add?id=<?php echo $album->id; ?>&is_active=0" >
                                                    <i class="icon_cloud"></i></a>
                                            <?php endif; ?>
                                            <a class="btn btn-danger" title="Delete"
                                               onclick="return confirm('Are you sure?');"
                                               href="<?php echo base_url() ?>admin/Galleries/delete/<?php echo $album->id; ?>">
