...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row" style="margin: 0 0 15px 0;">
            <a class="btn btn-primary" href="<?php echo base_url(); ?>myadminkw/Merchandise/add" title="Add Members">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-primary" title="Edit"
                                               href="<?php echo base_url() ?>myadminkw/Merchandise/add/<?php echo $row->id; ?>">
                                                <i class="icon_pencil-edit"></i></a>
                                            <?php if($row->is_active == 0): ?>
                                                <a class="btn btn-success" title="Publish"
                                                   href="<?php echo base_url() ?>myadminkw/Merchandise/add?id=<?php echo $row->id; ?>&is_active=1">
                                                    <i class="icon_cloud-upload_alt"></i></a>
                                            <?php else: ?>
                                                <a class="btn btn-warning" title="Unpublish"
                                                   href="<?php echo base_url() ?>myadminkw/Merchandise/add?id=<?php echo $row->id; ?>&is_active=0" >
                                                    <i class="icon_cloud"></i></a>
                                            <?php endif; ?>
                                            <a class="btn btn-danger" title="Delete"
                                               onclick="return confirm('Are you sure?');"
                                               href="<?php echo base_url() ?>myadminkw/Merchandise/delete/<?php echo $row->id; ?>">
