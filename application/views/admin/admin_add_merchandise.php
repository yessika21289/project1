            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form action="<?php echo base_url(); ?>myadminkw/Merchandise/add" class="form-horizontal"
                                ...
                                <div class="form-group form-song">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="desc" class="editor-2" rows="6">
                                                <?php echo $desc; ?>
                                            </textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="lyric">
                                            ...
                                            <span class="pull-right" style="margin-top:20px;">
                                                ...
                                                <a class="btn btn-danger" title="Cancel"
                                                   href="<?php echo base_url(); ?>myadminkw/Merchandise">Cancel
                                                </a>
                                            </span>
                                        </div>
                                    </div>
